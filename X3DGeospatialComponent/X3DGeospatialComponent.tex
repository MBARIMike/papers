...
\teaser{
    ...
    of instrumentation, and the terrain of Monterey Bay, California. X3D Geospatial nodes are used 
    to enable effective interactive exploration of high resolution geospatial data.}
...
optional rotateYUp rotation provided by the GeoOrigin child node. This lets the non-geospatial 
node be used together with geospatial nodes with the same GeoOrigin. The GeoOriginTransform has 
